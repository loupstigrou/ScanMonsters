package prog_mobile.uqac.com.scanmonsters.nearby;
...
public class DeviceMessage {
   // private static final Gson gson = new Gson();
    ...
    public static Message newNearbyMessage(String instanceId) {
        ...
        return null;//new Message(gson.toJson(deviceMessage).toString().getBytes(Charset.forName("UTF-8")));
    }
